...
def on_on_score():
    ...
    mySprite5 = sprites.create(img("""
            ...
            """),
        SpriteKind.player)
    game.show_long_text("Hi i'm Goku I well help become the marster in the sequel",
        DialogLayout.BOTTOM)
...
def on_update_interval():
    ...
    mySprite3 = sprites.create(img("""
            ...
            """),
        SpriteKind.enemy)
    mySprite3.set_position(randint(0, scene.screen_width()), scene.screen_height())
    mySprite3.set_velocity(0, -80)
